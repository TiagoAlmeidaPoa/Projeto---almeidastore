...
public class AlmeidastoreApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Category cat3 = new Category(null, "shoes");
		Category cat4 = new Category(null, "t-shirt");
		Category cat5 = new Category(null, "garden");
		Category cat6 = new Category(null, "tools");
		Category cat7 = new Category(null, "eletronics");
		...
		Address address1 = new Address(null, "E Broadway St", "470", "Ap 301", "Stranger", "91420590", customer1,
				city1);
